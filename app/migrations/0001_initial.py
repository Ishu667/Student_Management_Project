# Generated by Django 4.2.7 on 2024-05-26 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_year_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.sessionyear')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
                ('course_id', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='app.course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('exam_type', models.CharField(choices=[(1, 'QUATERLY'), (2, 'HALFYEARLY'), (3, 'ANNUAL')], default=1, max_length=10)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.sessionyear'),
        ),
        migrations.AddField(
            model_name='attendance',
            name='subject_id',
